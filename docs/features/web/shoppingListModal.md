...
### Contrato canónico de edit-mode y sincronización (referencia)

Para evitar duplicación y drift, las reglas normativas completas viven en:

- `docs/features/web/lists-management.md#contrato-final-de-edit-mode`
- `docs/usecases/list-use-cases.md#draft-invariant-and-recovery-policy`

Este documento conserva el comportamiento específico del modal y no replica el contrato transversal completo.
